...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend_asset/css/pe-icon-7-stroke.css') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('frontend_asset/css/swiper-bundle.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('frontend_asset/css/jquery-ui.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('frontend_asset/css/plugins/nice-select.css') }}" />
    <link rel="stylesheet" href="{{ asset('frontend_asset/css/plugins/venobox.css') }}" />
...
<body>
                ...
                <div class="row">
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <div class="signin-logo tx-center tx-24 tx-bold tx-inverse" ><img src="{{ asset('frontend_asset/images/logo/logo1.png') }}" style="width:50px; margin-bottom:10px;" alt="Site Logo" /><span style="font-size: 24px; color: #343a40; font-weight: 700; ">Meal</span><span style="font-size: 24px; color: #5B93D3; font-weight: 700; ">Deal</span></div>
                    ...
                    <div class="col align-self-center d-none d-lg-block">
                        <div class="main-menu">
                            <ul>
                                ...
                                <li class="dropdown " style="padding-left:200px;"><a href="#">My Account <i class="pe-7s-angle-down"></i></a>
                                    <ul class="sub-menu">
                    ...
                    <div class="col col-lg-auto align-self-center pl-0">
                        <div class="header-actions main-menu">
                            <a href="#" class="header-action-btn" data-bs-toggle="modal" data-bs-target="#searchActive"><i  class="pe-7s-search"></i> </a>
                        ...
                        <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                            <div class="single-wedge">
                                <div class="footer-logo">
                                    <div class="signin-logo tx-center tx-24 tx-bold tx-inverse" ><span style="font-size: 24px; color:aliceblue; font-weight: 700; ">Meal</span><span style="font-size: 24px; color: #5B93D3; font-weight: 700; ">Deal</span></div>
                                </div>
    ...
    {{-- <!-- Modal -->
    <div class="modal modal-2 fade" id="examle17" tabindex="-1" >
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                            <div class="product-details-content quickview-content">
                                ...
                                <div class="pricing-meta">
                                    <ul>
                                        <li class="old-price not-cut">{{ $package->package_des }}</li>
                                    </ul>
                                </div>
                                ...
                                <p class="mt-30px mb-0">{{ $package->id }} </p>
                    ...
                    <div class="modal-body">
                        <div class="d-flex align-items-center justify-content-center bg-sl-primary ht-100v">
                            ...
                            <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white">
                              <div class="signin-logo tx-center tx-24 tx-bold tx-inverse">Meal <img src="http://127.0.0.1:8000/starlight/img/logo.png" alt="" class="thumbnail img-responsive" style="max-width:17%;" srcset=""> <span class="tx-info tx-normal">Deal</span></div>
                              <div class="tx-center mg-b-60">Estimate Your Daily Meal With MealDeal</div>

                              <form action="http://127.0.0.1:8000/login" method="post">
                                <input type="hidden" name="_token" value="xzTzGQsNu0ZNtYVBD0qYcypbMK8ByRzSbXlfqLQG">        <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <a href="http://127.0.0.1:8000/forgot-password" class="tx-info tx-12 d-block mg-t-10">Forgot password?</a>
                                  </div>

                                  <button type="submit" class="btn btn-info btn-block">Sign In</button>
                              </form>

                              <div class="mg-t-60 tx-center">Not yet a member? <a href="http://127.0.0.1:8000/register" class="tx-info">Register Now</a></div>
                            </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src=""></script>
    <script src="{{ asset('frontend_asset/js/modernizr-3.11.2.min.js') }}"></script>

    <!--Plugins JS-->
    <script src="{{ asset('frontend_asset/js/swiper-bundle.min.js') }}"></script>
    ...
    <script src="{{ asset('frontend_asset/js/ajax-mail.js') }}"></script>
